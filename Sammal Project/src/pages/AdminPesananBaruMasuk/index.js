...
const AdminPesananBaruMasuk = ({navigation}) => {
  return (
	<ScrollView>
    <View style={styles.container}>
		<View style={{width: 300}}>
			<View style={{flexDirection: 'row'}}>
				...
				<Text style={{fontWeight: 'bold', fontSize: 24, marginLeft: 13, marginTop: 32}}>Pesanan Baru Masuk</Text>
			</View>
...
export default AdminPesananBaruMasuk;